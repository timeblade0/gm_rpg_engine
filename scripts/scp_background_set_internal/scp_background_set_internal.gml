function scp_background_set_internal(argument0, argument1, argument2, argument3) {
	...
	if (__prop == e__BG.Foreground)
	{
		...
		if (round(__val) != round(__isfore))
		{
			...
			scp_background_set_element(__bind, __visible, __val, __index, __x, __y, __htiled, __vtiled,__xscale,__yscale, __stretch, __hspeed, __vspeed, __blend, __alpha);
		}
	}
	else
	{
